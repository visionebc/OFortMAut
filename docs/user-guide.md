...
**exactly, never by network containment**: `192.0.2.0/16` does **not** cover
`192.0.2.0/22`. Doing network arithmetic on a string that may not be an address
...
1. **The URL map is the authority on what exists.** Every parameterless page in
   ...
   reason** (129 today — JSON feeds, downloads, redirects and fragments that
